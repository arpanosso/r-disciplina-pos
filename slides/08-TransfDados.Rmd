...
Vamos realizar a importação, via web, do banco de dados [geomorfologia.txt](https://raw.githubusercontent.com/arpanosso/r-disciplina-pos/refs/heads/master/data/geomorfologia.txt).

```{r}
library(tidyverse)
URL <- "https://raw.githubusercontent.com/arpanosso/r-disciplina-pos/refs/heads/master/data/geomorfologia.txt"
...
Classifique os registros por ordem alfabéticas de solos e utilize como critério de desempate o teor de fósforo disponível no solo em ordem decrescente.
```{r eval=FALSE}
geomorfologia %>% 
  arrange(Solo, desc(P)) %>% 
  View()
